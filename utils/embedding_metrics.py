...
def cal_all(gt, pred, w2v_path):
  # print("loading embeddings file...")
  w2v = KeyedVectors.load_word2vec_format(w2v_path, binary=True)
  r1 = average(gt, pred, w2v)
  r2 = greedy_match(gt, pred, w2v)
  r3 = extrema_score(gt, pred, w2v)

  return (f'{r[0]} +/- {r[1]} ( {r[2]} )' for r in [r1, r2, r3])
